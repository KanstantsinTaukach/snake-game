...
namespace
{
	FVector LinkPositionToVector(const SnakeGame::Position& Position, int32 CellSize, const SnakeGame::Dim& Dims)
	{
...
void ASG_Snake::SetModel(const TSharedPtr<SnakeGame::Snake>& InSnake, int32 InCellSize, const SnakeGame::Dim& InDims)
{
	Snake = InSnake;
	CellSize = InCellSize;
	Dims = InDims;
